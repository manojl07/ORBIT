...
const Feed = () => {
  ...
  const { data, isLoading, isError, error, fetchNextPage, hasNextPage, isFetchingNextPage, } = useInfiniteFeed();
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <h2 className="text-white text-lg font-semibold">Your feed is empty</h2>
          <p className="text-zinc-500 text-sm mt-2">Create your first post and start your journey on Orbit.</p>
